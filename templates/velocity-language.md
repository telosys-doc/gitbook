...
A template is a text file mixing fixed parts and dynamic parts based on references to variables an objects. A **reference** to a variable or an object starts with "**$**". 
